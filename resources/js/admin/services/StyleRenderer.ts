...
class StyleRenderer {
	public render(style: BlockStyle) {
		let string = ''
			...
			+ 'margin:' + style.margin.top + ('auto' !== style.margin.top ? style.marginMeasure + ' ' : ' ') + style.margin.right + ('auto' !== style.margin.right ? style.marginMeasure + ' ' : ' ') + style.margin.bottom + ('auto' !== style.margin.bottom ? style.marginMeasure +  ' ' : ' ') + style.margin.left + ('auto' !== style.margin.left ? style.marginMeasure + ';' : ';')
